...
mod tests {
    ...
    fn test_purchase() {
        ...
        let info = mock_info(BUYER, &coins(10_000000000000000000, "inj"));
    ...
    fn test_purchase_wrong_denom() {
        ...
        let msg = ExecuteMsg::Purchase {};
        let info = mock_info(BUYER, &coins(10_000000000000000000, "wrong_denom"));
        let err = execute(deps.as_mut(), mock_env(), info, msg).unwrap_err();
    ...
    fn test_multiple_purchases() {
        ...
        let msg = ExecuteMsg::Purchase {};
        let info = mock_info(BUYER, &coins(5_000000000000000000, "inj"));
        execute(deps.as_mut(), mock_env(), info, msg.clone()).unwrap();

        // Second purchase: 3 INJ
        let info = mock_info(BUYER, &coins(3_000000000000000000, "inj"));
    ...
    fn test_preview_purchase_different_amounts() {
        ...
        let test_cases = vec![
            ...
            (
                100_000000000000000000u128,
                10000_000000000000000000u128,
            ),
        ];
    ...
    fn test_preview_purchase_after_rate_change() {
        ...
        assert_eq!(
            preview.token_amount,
            Uint128::new(2000_000000000000000000)
        );
